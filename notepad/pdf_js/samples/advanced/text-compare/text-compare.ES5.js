!(function(t) {
  ...
  function(t, n, e) {
    ...
    if (e(8)) {
      var o = e(30),
        ...
        jt = function() {
          return dt.apply(Lt ? ht.call(It(this)) : It(this), arguments);
        },
        Nt = {
      ...
      d(qt, Bt),
        p(qt, vt, Bt.values),
        d(qt, { slice: Rt, set: kt, constructor: function() {}, toString: pt, toLocaleString: jt }),
        Ft(qt, 'buffer', 'b'),
        Ft(qt, 'byteOffset', 'o'),
        Ft(qt, 'byteLength', 'l'),
        Ft(qt, 'length', 'e'),
          ...
          b
            ? ((d = e(function(t, e, r, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(e)) {
                  if (!(e instanceof $ || 'ArrayBuffer' == (a = x(e)) || 'SharedArrayBuffer' == a)) return St in e ? Ct(d, e) : Tt.call(d, e);
                  (i = e), (h = Pt(r, n));
                  var v = e.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              J(m !== Function.prototype ? O(v).concat(O(m)) : O(v), function(t) {
                t in d || p(d, t, v[t]);
              }),
              (d.prototype = E),
              o || (E.constructor = d));
  ...
  function(t, n, e) {
    ...
    function q(t, n, e, r, o, i) {
      ...
      for (var c = t[C]._b, a = u + t[T], f = r(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
  ...
  function(t, n, e) {
    ...
    for (var ot = F(d.store), it = 0; ot.length > it; ) g(ot[it++]);
    c(c.S + c.F * !G, 'Symbol', {
      for: function(t) {
    ...
    var a = function(t) {
        return new Promise(function(n) {
          WebViewer(
            ...
            (t.instance = e),
              e.UI.disableTools(),
              e.UI.disableFeatures(p.Annotations),
              o.addEventListener(
                'documentLoaded',
                r(
                  regeneratorRuntime.mark(function t() {
                    ...
                    return regeneratorRuntime.wrap(function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            (r = o.getDisplayModeManager()),
                              (i = r.isVirtualDisplayEnabled() ? new a.VirtualDisplayMode(o, a.DisplayModes.Single) : new a.DisplayMode(o, a.DisplayModes.Single)),
                              r.setDisplayMode(i),
            ...
            (v.onscroll = function() {
              h(v.scrollLeft, v.scrollTop), clearTimeout(void 0);
            }),
